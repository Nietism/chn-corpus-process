...
def characterToimage(word, imagename):
    # you can load HYKaiTiJ.ttf to generated Kai Font Charaters
    font = pygame.font.Font("msyh.ttc", 200)
    rtext = font.render(word, True, (0, 0, 0), (255, 255, 255))
    pygame.image.save(rtext, "./chn-char-lib/" + imagename + ".png")


# def myCharacterToimage(word, imagename):
...
def getPunctuation():
    stopwords = ["阿", "啊", "呃", "欸", "哇", "呀", "也", "耶", "哟", "欤", "呕", "噢", "呦", "嘢", "吧", "罢", "呗", "啵", "的", "家", "啦", "来", "唻",
                 "了", "嘞", "哩", "咧", "咯", "啰", "喽", "吗", "嘛", "嚜", "么", "哪", "呢", "呐", "否", "呵", "哈", "不", "兮", "般", "则", "连", "罗", "噻", "哉", "呸"]
    # punc = ['？','。','。。。','！','’','，','…','《','》', '‘',
    # 		'；', '，', '“', '”', '）', '（', '·', '~', '％',
    # 		'：', '．', '—', '、', '～', '°', '　']
    #
